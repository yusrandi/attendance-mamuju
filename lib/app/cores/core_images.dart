class CoreImages {
  ...
  static String logoMamujuImages = "assets/images/mamuju.png";
  ...
  static String locationLottie = "assets/lotties/location.json";
  static String mapsLottie = "assets/lotties/maps.json";
  static String calendarLottie = "assets/lotties/calendar.json";
  static String purpleLottie = "assets/lotties/purple.json";
}
